  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="py-20 text-center">
        <h2 className="text-2xl font-bold text-white mb-4">Test Links</h2>
        <div className="space-y-4">
          <a href="/test-link" className="text-blue-400 hover:text-blue-300 block">Test Link (Anchor)</a>
          <a href="/solutions/research" className="text-green-400 hover:text-green-300 block">Research Page (Anchor)</a>
          <a href="/about" className="text-yellow-400 hover:text-yellow-300 block">About Page (Anchor)</a>
        </div>
      </div>
